# -*- coding: utf-8 -*-
# Generated by Django 1.11.24 on 2019-09-19 19:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('北京', '北京'), ('上海', '上海'), ('广州', '广州'), ('深圳', '深圳'), ('重庆', '重庆'), ('西安', '西安'), ('武汉', '武汉'), ('青岛', '青岛')], max_length=20, verbose_name='常居地')),
            ],
        ),
    ]
